...
void OnTick()
  {
   ...
   double ma0 = iMA(NULL,0,20,0,MODE_SMA,PRICE_CLOSE,2);
   double ma10 = iMA(NULL,0,50,0,MODE_SMA,PRICE_CLOSE,2);

   bool uptrend=ma>ma1 && ma0<ma10;
   bool downtrend=ma<ma1 && ma0>ma10;;
